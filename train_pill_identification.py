...
def train_epoch(
    ...
    if ddp_manager.is_distributed:
        ...
        total_loss = metrics_tensor[0].item() / metrics_tensor[1].item()
        total_script_acc = metrics_tensor[2].item() / metrics_tensor[3].item()
        total_pill_acc = metrics_tensor[4].item() / metrics_tensor[5].item()
    else:
        total_loss = loss_meter.avg
        total_script_acc = script_acc_meter.avg
        total_pill_acc = pill_acc_meter.avg
...
def validate(
    ...
    return {
        ...
        'script_acc': total_script_acc,
        'pill_acc': total_pill_acc,
        'correct_script_acc': correct_script_acc_meter.avg,
        'incorrect_script_acc': incorrect_script_acc_meter.avg
    }
